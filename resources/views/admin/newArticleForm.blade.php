...
@section('content')
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">{{auth()->user()->name}} create a new site Article </h1>
          </div>
      <form role="form-horizontal"  action="/admin/article/save" method="post">
                    ...
                    <div class="compose-editor">
                      <textarea class="content form-control @error('word') is-invalid @enderror" rows="9" name="word" value="{{ old('word') }}" required></textarea><hr>
                                   @error('word')
                                       <span class="invalid-feedback" role="alert">
                                           <strong>{{ $message }}</strong>
                                       </span>
